...
import com.yhg.pickup.utils.NetWorkUtils;
...
public class ApiRetrofit {
    ...
    private Interceptor mCacheInterceptor = chain -> {
        ...
        if (!NetWorkUtils.isNetworkAvailable(PickUpApp.getInstance())) {
    ...
    public ApiRetrofit() {
        //cache url
        File httpCacheDirectory = new File(PickUpApp.getInstance().getCacheDir(), "responses");
